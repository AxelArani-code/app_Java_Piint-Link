...
public class ViewEstilo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_estilo);
        ...
        recyclerView = findViewById(R.id.recycler_View_Estilo);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("hits_estilo");
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(ViewEstilo.this,exampleItems);
