...
public class  ViewEscritorio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_escritorio);
        ...
        recyclerView = findViewById(R.id.recycler_View_Escritorio);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("hits_escritorio");
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(ViewEscritorio.this,exampleItems);
