...
public class ViewBeatle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_beatle);
        ...
        recyclerView = findViewById(R.id.recycler_View_beatle);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("hits_the_beatles");
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(ViewBeatle.this,exampleItems);
