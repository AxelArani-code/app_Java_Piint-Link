...
public class View_Dubujo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view__dubujo);
        ...
        recyclerView = findViewById(R.id.recycler_View_Dubujo);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(View_Dubujo.this,exampleItems);
