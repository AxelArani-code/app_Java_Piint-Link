...
public class ViewMotos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_motos);
        ...
        recyclerView = findViewById(R.id.recycler_View_Motos);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("hits_motos");
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(ViewMotos.this,exampleItems);
