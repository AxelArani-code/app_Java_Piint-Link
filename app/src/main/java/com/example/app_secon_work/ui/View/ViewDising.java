...
public class ViewDising extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_dising);
        ...
        recyclerView = findViewById(R.id.recycler_View_desing);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("hits_diseño_web");
                            ...
                            //Adapter
                            exampleAdapter = new ExampleAdapter(ViewDising.this,exampleItems);
